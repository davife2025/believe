...
function loadLocal(): Record<string, { status: string; note?: string; currentPage?: number; totalPages?: number }> {
  try {
...
function saveLocal(data: Record<string, { status: string; note?: string; currentPage?: number; totalPages?: number }>) {
...
export function ReadingList() {
  ...
  const updateBook = (id: string, updates: Partial<{ status: string; note: string; currentPage: number; totalPages: number }>) => {
